...
public class GetStockDivTrxInfo {
	...
	protected void kernel() throws Exception {
		...
		KMyMoneyStockDividendTransaction specTrx = new KMyMoneyStockDividendTransactionImpl(
				(KMyMoneyTransactionImpl) genTrx);
		if ( specTrx == null ) {
			System.err.println(
					"Error: Transaction with ID '" + trxID + "' does not meet criteria for stock dividend transaction");
			System.exit(-1);
		}
